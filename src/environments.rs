...
pub fn shifumi() -> (Vec<i32>, Vec<i32>, Vec<i32>, Vec<i32>, Vec<Vec<Vec<Vec<f32>>>>){
    ...
    p[0][0][1][1] = 1f32/3f32; //# PP
    p[0][0][2][0] = 1f32/3f32; //# PF
    p[0][0][3][2] = 1f32/3f32; //# PC

    p[0][1][4][2] = 1f32/3f32; //# FP
    p[0][1][5][1] = 1f32/3f32; // # FF
    p[0][1][6][0] = 1f32/3f32; // # FC

    p[0][2][7][0] = 1f32/3f32; // # CP
    p[0][2][8][2] = 1f32/3f32; // # CF
    p[0][2][9][1] = 1f32/3f32; // # CC
    // ###############
    p[1][0][10][1] = 1f32; // # PP PP
    p[1][1][11][2] = 1f32; // # PP FP
    p[1][2][12][0] = 1f32; // # PP CP

    p[2][0][13][1] = 1f32; // # PF PP
    p[2][1][14][2] = 1f32; // # PF FP
    p[2][2][15][0] = 1f32; // # PF CP

    p[3][0][16][1] = 1f32; // # PC PP
    p[3][1][17][2] = 1f32; // # PC FP
    p[3][2][18][0] = 1f32; // # PC CP
    //###############
    p[4][0][19][0] = 1f32; // # FP PF
    p[4][1][20][1] = 1f32; // FP FF
    p[4][2][21][2] = 1f32; //# FP CF

    p[5][0][22][0] = 1f32; // FF PF
    p[5][1][23][1] = 1f32; // FF FF
    p[5][2][24][2] = 1f32; // FF CF

    p[6][0][25][0] = 1f32; // FC PF
    p[6][1][26][1] = 1f32; // FC FF
    p[6][2][27][2] = 1f32; // FC CF
    //###############
    p[7][0][28][2] = 1f32; // CP PC
    p[7][1][29][0] = 1f32; // CP FC
    p[7][2][30][1] = 1f32; // CP CC

    p[8][0][31][2] = 1f32; // CF PC
    p[8][1][32][0] = 1f32; // CF FC
    p[8][2][33][1] = 1f32; // CF CC

    p[9][0][34][2] = 1f32; // CC PC
    p[9][1][35][0] = 1f32; // CC FC
    p[9][2][36][1] = 1f32; // CC CC
