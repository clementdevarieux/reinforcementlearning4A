...
impl SecretEnv0 {
    ...
    pub fn p(&self, s: usize, a: usize, s_p: usize, r: usize) -> f32 {
        ...
        unsafe {
            secret_env_0_transition_probability(s, a, s_p, r)
        }
    }
    ...
    pub fn num_states(&self) -> i32 {
        ...
        unsafe {
            secret_env_0_num_states() as i32
        }
    }
    ...
    pub fn agent_pos(&self) -> i32{
        ...
        unsafe {
            secret_env_0_state_id(self.env) as i32
        }
    }
    ...
    pub fn num_actions(&self) -> i32 {
        ...
        unsafe {
            secret_env_0_num_actions() as i32
        }
    }
    ...
    pub fn available_actions_len(&self) -> i32 {
        ...
        unsafe {
            secret_env_0_available_actions_len(self.env) as i32
        }
    }
