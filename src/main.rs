...
//     writeln!(file, "{}", output_score);
    ...
    // Monte carlo exploring start, commencer par un etat random !
...
//         secretenv1.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_off_policy (gammma = {}, epsilon = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, nb_iter, max_steps, durations_secretenv1.iter().sum::<u128>() / durations_secretenv1.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv1.reset()
//     }
//     let output = format!("Average elapsed time over {} Q_learning_off_policy (gammma = {}, epsilon = {}, alpha = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, alpha, nb_iter, max_steps, durations_secretenv1.iter().sum::<u128>() / durations_secretenv1.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
// //     secretenv2.reset()
// // }
// // let output = format!("Average elapsed time over {} policy_iteration (theta = {}, gammma = {}): {}", number_of_tests, theta, gamma, durations_secretenv2.iter().sum::<u128>() / durations_secretenv2.len() as u128);
// // println!("{}", output);
// // let mut file = OpenOptions::new()
// //     .create(true)
// //     .append(true)
...
// //     secretenv2.reset()
// // }
// // let output = format!("Average elapsed time over {} value_iteration (theta = {}, gammma = {}): {}", number_of_tests, theta, gamma, durations_secretenv2.iter().sum::<u128>() / durations_secretenv2.len() as u128);
// // println!("{}", output);
// // let mut file = OpenOptions::new()
// //     .create(true)
// //     .append(true)
...
//         secretenv2.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_exploring_starts (gammma = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, nb_iter, max_steps, durations_secretenv2.iter().sum::<u128>() / durations_secretenv2.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv2.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_fv_on_policy (gammma = {}, epsilon = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, nb_iter, max_steps, durations_secretenv2.iter().sum::<u128>() / durations_secretenv2.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv2.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_off_policy (gammma = {}, epsilon = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, nb_iter, max_steps, durations_secretenv2.iter().sum::<u128>() / durations_secretenv2.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv2.reset()
//     }
//     let output = format!("Average elapsed time over {} Q_learning_off_policy (gammma = {}, epsilon = {}, alpha = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, alpha, nb_iter, max_steps, durations_secretenv2.iter().sum::<u128>() / durations_secretenv2.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
// //     secretenv3.reset()
// // }
// // let output = format!("Average elapsed time over {} policy_iteration (theta = {}, gammma = {}): {}", number_of_tests, theta, gamma, durations_secretenv3.iter().sum::<u128>() / durations_secretenv3.len() as u128);
// // println!("{}", output);
// // let mut file = OpenOptions::new()
// //     .create(true)
// //     .append(true)
...
// //     secretenv3.reset()
// // }
// // let output = format!("Average elapsed time over {} value_iteration (theta = {}, gammma = {}): {}", number_of_tests, theta, gamma, durations_secretenv3.iter().sum::<u128>() / durations_secretenv3.len() as u128);
// // println!("{}", output);
// // let mut file = OpenOptions::new()
// //     .create(true)
// //     .append(true)
...
//         secretenv3.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_exploring_starts (gammma = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, nb_iter, max_steps, durations_secretenv3.iter().sum::<u128>() / durations_secretenv3.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv3.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_fv_on_policy (gammma = {}, epsilon = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, nb_iter, max_steps, durations_secretenv3.iter().sum::<u128>() / durations_secretenv3.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv3.reset()
//     }
//     let output = format!("Average elapsed time over {} monte_carlo_off_policy (gammma = {}, epsilon = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, nb_iter, max_steps, durations_secretenv3.iter().sum::<u128>() / durations_secretenv3.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
...
//         secretenv3.reset()
//     }
//     let output = format!("Average elapsed time over {} Q_learning_off_policy (gammma = {}, epsilon = {}, alpha = {}, nb_iter = {}, max_steps = {}): {}", number_of_tests, gamma, epsilon, alpha, nb_iter, max_steps, durations_secretenv3.iter().sum::<u128>() / durations_secretenv3.len() as u128);
//     println!("{}", output);
//     let mut file = OpenOptions::new()
//         .create(true)
//         .append(true)
